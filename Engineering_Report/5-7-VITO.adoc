...
1. Deployment of simplified application package
2. Direct execution of arbitrary command in arbitrary docker image, no deploy needed
3. Deploy of a full WPS packaged as Docker.
