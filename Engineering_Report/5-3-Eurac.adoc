...
The reasons to use WPS 1.0.0 were the following:

- To ensure compatibility with a possibly large set of tools and libraries
- 

The operations actually implemented as a proof of concept are the following:
- DeployProcess
- ExecuteProcess
- UndeployProcess
