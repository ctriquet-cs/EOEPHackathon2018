...
The proposed implementation uses a OWS Condext Document (OWC) to describe and deploy an application. This seems a very good standard to convey this information.
...
Here is a sample for the ProcessParameters Input with the corresponding request. 
**ProcessParameters:**
```json
{
	"cloud":"NA",
...
The variable **$Data** is a placeholder for the data referenced by the user, or by a search offering operation.
